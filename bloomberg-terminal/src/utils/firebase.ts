...
const firebaseConfig = {
  apiKey: process.env.REACT_APP_BLAHHBLAHH1,
  authDomain: process.env.REACT_APP_BLAHHHLAHH2,
  projectId: process.env.REACT_APP_BLAHHHLAHH3,
  storageBucket: process.env.REACT_APP_BLAHHHLAHH4,
  messagingSenderId: process.env.REACT_APP_BLAHHHLAHH5,
  appId: process.env.REACT_APP_BLAHHHLAHH6,
  measurementId: process.env.REACT_APP_BLAHHHLAHH7,
};
// Initialize Firebase
